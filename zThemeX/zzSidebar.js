		...
		case "related":
			...
			$.ajax({
				...
				success: function(a) {
						...
						for (var o = 0, n = r; o < n.length; o++) {
							...
							switch (t) {
								...
								case "style1":
									switch (o) {
										case 0:
											y += '<div class="style1-left"><div class="style1-item card-style item-' + o + '"><a title="' + d + '" class="entry-image-wrap before-mask ' + u + '" href="' + c + '"><span class="entry-thumb" data-image="' + p + '"/></a><div class="entry-header entry-info">' + m + '<h2 class="entry-title"><a href="' + c + '" title="' + d + '">' + d + "</a></h2>" + g[0] + "</div></div></div>";
											break;
										default:
											y += (1 == o ? '<div class="style1-right">' : "") + '<div class="style1-item item-' + o + '"><a title="' + d + '" class="entry-image-wrap ' + u + '" href="' + c + '"><span class="entry-thumb" data-image="' + p + '"/></a><div class="entry-header"><h2 class="entry-title"><a href="' + c + '" title="' + d + '">' + d + "</a></h2>" + g[1] + "</div></div>" + (o == l - 1 ? "</div>" : "")
									}
									break;
								case "style2":
									switch (o) {
										case 0:
											y += '<div class="style2-item card-style item-' + o + '"><a title="' + d + '" class="entry-image-wrap before-mask ' + u + '" href="' + c + '"><span class="entry-thumb" data-image="' + p + '"/></a><div class="entry-header entry-info">' + m + '<h2 class="entry-title"><a href="' + c + '" title="' + d + '">' + d + "</a></h2>" + g[0] + "</div></div>";
											break;
										default:
											y += '<div class="style2-item item-' + o + '"><a title="' + d + '" class="entry-image-wrap ' + u + '" href="' + c + '"><span class="entry-thumb" data-image="' + p + '"/></a><div class="entry-header"><h2 class="entry-title"><a href="' + c + '" title="' + d + '">' + d + "</a></h2>" + g[1] + "</div></div>"
									}
									break;
								case "style3":
								case "style4":
									y += '<div class="' + t + "-item item-" + o + '"><a title="' + d + '" class="entry-image-wrap ' + u + '" href="' + c + '"><span class="entry-thumb" data-image="' + p + '"></span></a><div class="entry-header"><h2 class="entry-title"><a title="' + d + '" href="' + c + '">' + d + "</a></h2>" + ("style4" == t ? "" + g[0] : "" + g[1]) + "</div></div>";
									break;
								case "leftstyle":
								case "rightstyle":
									switch (o) {
									...
									break;
								case "videostyle":
									y += '<div class="videostyle-item card-style item-' + o + '"><a title="' + d + '" class="entry-image-wrap before-mask is-video" href="' + c + '"><span class="entry-thumb" data-image="' + p + '"></span></a><div class="entry-header entry-info">' + m + '<h2 class="entry-title"><a title="' + d + '" href="' + c + '">' + d + "</a></h2>" + (0 == o ? "" + g[0] : "" + g[1]) + "</div></div>";
									break;
								case "mainstyle":
									switch (o) {
										case 0:
					...
					switch (t) {
						case "mega":
							i += "</div>", e.append(i).addClass("mega"), e.find("a:first").attr("href", function(e, t) {
								switch (s) {
									case "recent":
...
function ajaxMega(e, t, a, s, i) {
	if (i.match("newsection")) {
		if ("mega" == t) return getAjax(e, t, a, s);
		e.append('<div class="ul mega-items no-items">' + msgError() + "</div>")
	}
}
...
function ajaxBlock(e, t, a, s, i, r, o) {
	if (i.match("newsection")) {
		if ("style1" == t || "style2" == t || "style3" == t || "style4" == t || "leftstyle" == t || "rightstyle" == t || "videostyle" == t) return 0 != s && (r = "recent" == s ? "/search" : "/search/label/" + s, o = "" != viewAllText.trim() ? viewAllText : ztexport.viewAll, e.parent().find(".widget-title").append('<a href="' + r + '" class="wt-l">' + o + "</a>")), getAjax(e, t, a, s);
		e.html(msgError())
	}
}
function ajaxWidget(e, t, a, s, i) {
	if (i.match("newsection")) {
		if ("mainstyle" == t || "simplestyle" == t || "comments" == t) return getAjax(e, t, a, s);
		e.html(msgError())
	}
}
...
fixedMenu = "undefined" == typeof fixedMenu || fixedMenu, viewAllText = "undefined" != typeof viewAllText ? viewAllText : ztexport.viewAll, $("#zient-main-nav").menuzt(), $("#zient-main-nav .widget").addClass("show-menu"), $(".show-search").on("click", function() {
...
}), $(".post-body u").each(function() {
	var e = $(this),
		t = e.text(),
		a = t.toLowerCase().trim();
	a.match(/(?:\$ads\=\{1\})/g) && e.replaceWith('<div id="zient-new-before-ad"/>'), a.match(/(?:\$ads\=\{2\})/g) && e.replaceWith('<div id="zient-new-after-ad"/>'), a.match("[toc]") && (t = 0 != shortCodezt(t, "title") ? shortCodezt(t, "title") : "Table of Contents", e.replaceWith('<div class="toczt-wrap"><div class="toczt-inner"><a href="javascript:;" class="toczt-title" role="button" title="' + t + '"><span class="toczt-title-text">' + t + '</span></a><ol id="toczt"></ol></div></div>'), $(".toczt-title").each(function(e) {
	...
	})), a.match("[cf]") && (e.replaceWith('<div class="contact-form"/>'), $(".contact-form").append($("#ContactForm1"))), a.match("{leftsidebar}") && ($("body").addClass("is-left"), e.remove()), a.match("{rightsidebar}") && ($("body").addClass("is-right"), e.remove()), a.match("{fullwidth}") && ($("body").addClass("no-sidebar"), e.remove())
	...
	var e = $(this),
		...
		a = e.html();
	if (t.match("[as]")) {
		const t = a.replace("[as]", "");
		e.replaceWith('<div class="alert-message alert-success">' + t + "</div>")
	}
	if (t.match("[ai]")) {
		const t = a.replace("[ai]", "");
		e.replaceWith('<div class="alert-message alert-info">' + t + "</div>")
	}
	if (t.match("[aw]")) {
		const t = a.replace("[aw]", "");
	...
	null != s && (e = s.toLowerCase(), ajaxMega(a, "mega", 5, shortCodezt(s, "label"), e))
	...
	var s = $(this),
		i = $(window),
		r = s.data("shortcode");
	null != r && (mtc = r.toLowerCase(), e = shortCodezt(r, "results"), t = shortCodezt(r, "label"), "leftstyle" != (a = shortCodezt(r, "type")) && "rightstyle" != a || s.parent().addClass("column-style type-" + a), i.on("resize scroll", function r() {
